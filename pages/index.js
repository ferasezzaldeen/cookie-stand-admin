       ...
       <div>
         <form className='p-6 bg-green-300 rounded-2xl' onSubmit={formHandler} >
           <h2>Create Cookie Stand</h2>
            ...
            <input type="text" name='location' className='w-9/12 my-3 bg-gray-200'  ></input>
            <div className='flex flex-row'>
                <div className='flex flex-col p-3'>
                    <label>Minimum customer per Hour</label>
                    <input type="number" name='min'  className='bg-gray-200' ></input>
                </div>
                <div className='flex flex-col p-3'>
                    <label>Maximum customer per Hour</label>
                    <input type="number" name='max' className='bg-gray-200' ></input>
                </div>
                <div className='flex flex-col p-3'>
                    <label>Avarage Cookies per sale</label>
                    <input type="number" name='avg'   className='bg-gray-200' step='.1' ></input>
                </div>
